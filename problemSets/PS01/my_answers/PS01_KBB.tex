...
\begin{enumerate}
	...
	\begin{enumerate}[label=(\alph*)]
		\item Find the Mean
			...
			\lstinputlisting[language=R, firstline=48, lastline=48]{PS01_KBB.R}  			
		
		\item Find the Standard Error
					\lstinputlisting[language=R, firstline=51, lastline=51]{PS01_KBB.R}  
					
		\item Calculate the associated t-statistic using the degrees of freedom
					\lstinputlisting[language=R, firstline=53, lastline=57]{PS01_KBB.R}  
					
					
		\item Obtain the Upper and Lower Bounds
					\lstinputlisting[language=R, firstline=59, lastline=60]{PS01_KBB.R}  
					
					\lstinputlisting[language=R, firstline=61, lastline=62]{PS01_KBB.R}  
...
\textbf{The 5 steps of Hypothesis Testing}
		...
		\item Calculate the T-Statistic
			...
			\lstinputlisting[language=R, firstline=74, lastline=76]{PS01_KBB.R}  
		
		\item Calculate the P-Value
			\lstinputlisting[language=R, firstline=81, lastline=82]{PS01_KBB.R}  
